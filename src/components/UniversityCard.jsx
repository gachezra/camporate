...
const UniversityCard = ({ university, onReviewClick, isProfile }) => {
  return (
    <div className="bg-cream-light rounded-xl shadow-2xl m-4 p-6 w-64 text-center">
      ...
      <p className="text-brown font-bold mb-2"><span role="img">⭐</span> {university.overall_rating.toFixed(1)}/10</p>
      <p className="text-brown text-sm mb-1">Academics: {university.academic_rating.toFixed(1)}/10</p>
      <p className="text-brown text-sm mb-1">Facilities: {university.facilities_rating.toFixed(1)}/10</p>
      <p className="text-brown text-sm mb-1">Social Life: {university.social_life_rating.toFixed(1)}/10</p>
      <p className="text-brown text-sm mb-1">Career Prospects: {university.career_prospects_rating.toFixed(1)}/10</p>
